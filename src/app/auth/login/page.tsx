...
const Login = () => {
	return (
		<>
						...
						<div>
							<div className="text-center max-w-lg px-1.5 m-auto">
								...
								<p className="text-bgray-600 dark:text-bgray-50 text-sm font-medium">
									...
									early. Get a
									<span className="text-success-300 font-bold">$20</span> bonus when
			...
			<div
				className="modal hidden fixed inset-0 z-50 overflow-y-auto flex items-center justify-center"
				id="multi-step-modal"
			>
				<div
					className="modal-overlay absolute inset-0 bg-gray-500 opacity-75 dark:bg-bgray-900 dark:opacity-50"></div>
				<div className="modal-content w-full max-w-lg mx-auto px-4">
					<div className="step-content step-1">
						<div
							className="relative max-w-[492px] transform overflow-hidden rounded-lg bg-white dark:bg-darkblack-600 p-8 text-left transition-all"
						>
							...
							<div>
								<a href="signin.html" className="block mb-7">
									<img src="/assets/images/logo/logo-color.svg" className="block dark:hidden" alt=""/>
									<img src="/assets/images/logo/logo-white.svg" className="hidden dark:block" alt=""/>
								</a>
					...
					<div className="step-content step-2 hidden">
						<div
							className="relative max-w-lg transform overflow-hidden rounded-lg bg-white dark:bg-darkblack-600 p-8 text-left transition-all"
						>
							<div className="absolute top-0 right-0 pt-5 pr-5">
								<button
									type="button"
							...
							<div>
								...
								<form>
									...
									<button className="block text-sm font-bold text-success-300 mb-8">
										Send the code again
									</button>
									<button
										type="button"
					...
					<div className="step-content step-3 hidden">
						<div
							className="relative  transform overflow-hidden rounded-lg bg-white dark:bg-darkblack-600 p-8 text-left transition-all"
						>
							<div className="absolute top-0 right-0 pt-5 pr-5">
								<button
									type="button"
