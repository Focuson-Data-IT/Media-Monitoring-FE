...
const OurSelect: React.FC<TOurSelect> = ({options = [], setSelectedOption}) => {
		...
		<Select
			...
			styles={{
				option: (provided, state) => ({
					...provided,
					backgroundColor: state.isSelected ? "lightblue" : "white", // Warna untuk opsi terpilih
					color: state.isSelected ? "black" : "gray", // Warna teks untuk opsi terpilih
					":hover": {
						backgroundColor: state.isSelected ? "lightblue" : "lightgray", // Warna saat hover
					},
				}),
			}}
			components={{
...
// };
//
// const OurSelect: React.FC<TOurSelect> = ({permaOptions = null, options, disabled, setSelectedOption = null}) => {
// 	const [selectedOptions, setSelectedOptions] = useState<any[]>(options || ['']);
//
// 	const handleChange = (selected) => {
// 		setSelectedOption(selected)
